namespace KPO2.Worker.Services.RssService
{
	...
	public class RssServiceProkazan : IRssService
	{
		private const string RssUrlProkazan = "http://prokazan.ru/rss.xml";

		public RssItem[] GetRssItems()
		{
			var result = new List<RssItem>();
			// Получение данных с помощью запроса
			var rssResult = WebRequestUtils.Get(RssUrlProkazan, Encoding.UTF8);
			// Парсинг данных
